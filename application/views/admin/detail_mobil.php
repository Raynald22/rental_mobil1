        ...
        <?php foreach ($detail as $dt) : ?>
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-5">
                            <img width="300px" src="<?= base_url() . 'assets/upload/' . $dt->gambar ?>">
                        </div>
                        <div class="col-md-7">
                            <table class="table">
                                <tr>
                            ...
                            <a href="<?= base_url('admin/data_mobil/update_mobil/' . $dt->id_mobil) ?>" class="btn btn-sm btn-primary ml-1">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
