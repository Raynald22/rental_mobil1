...
<head>
	...
	<!--=== Favicon ===-->
	<link rel="apple-touch-icon" sizes="180x180" href="<?= base_url() ?>/assets/assets_shop/img/icon/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="<?= base_url() ?>/assets/assets_shop/img/icon/favicon-32x32.png">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-3 text-left">
						<i class="fa fa-map-marker"></i> Cempaka Putih,Jakarta
					</div>
					<!--== Single HeaderTop End ==-->

					<!--== Single HeaderTop Start ==-->
					<div class="col-lg-3 text-center">
						<i class="fa fa-mobile"></i> +62 84771771
					</div>
					<!--== Single HeaderTop End ==-->
						...
						<nav class="mainmenu alignright">
							<ul>
								...
								<?php if ($this->session->userdata('nama')) { ?>
									<li><a href="<?= base_url('auth/logout') ?>">Hi, <?php echo $this->session->userdata('nama') ?><span> | Logout</span></a></li>
								<?php
								} else { ?>
