        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="about-image">
                    <img src="<?= base_url() ?>/assets/assets_shop/img/home-2-about.png" alt="JSOFT">
                </div>
            </div>
            <!-- About Video End -->
        </div>
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="row popular-car-gird">
                                    ...
                                    <div class="single-popular-car">
                                        <div class="p-car-thumbnails">
                                            <a class="car-hover" href="assets/img/car/car-1.jpg">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/car/car-1.jpg" alt="JSOFT">
                                            </a>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 hat sedan">
                                    <div class="single-popular-car">
                                        <div class="p-car-thumbnails">
                                            <a class="car-hover" href="<?= base_url() ?>/assets/assets_shop/img/car/car-2.jpg">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/car/car-2.jpg" alt="JSOFT">
                                            </a>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 suv con mpv">
                                    <div class="single-popular-car">
                                        <div class="p-car-thumbnails">
                                            <a class="car-hover" href="<?= base_url() ?>/assets/assets_shop/img/car/car-3.jpg">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/car/car-3.jpg" alt="JSOFT">
                                            </a>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 con hat">
                                    <div class="single-popular-car">
                                        <div class="p-car-thumbnails">
                                            <a class="car-hover" href="<?= base_url() ?>/assets/assets_shop/img/car/car-4.jpg">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/car/car-4.jpg" alt="JSOFT">
                                            </a>
                                        </div>
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="tab_item_1" data-toggle="tab" href="#team_member_1" role="tab" aria-selected="true">
                                            <div class="team-mem-icon">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/team/team-mem-thumb-1.png" alt="JSOFT">
                                            </div>
                                            <h5>Raju Ahammad</h5>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="tab_item_2" data-toggle="tab" href="#team_member_2" role="tab" aria-selected="true">
                                            <div class="team-mem-icon">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/team/team-mem-thumb-3.png" alt="JSOFT">
                                            </div>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="tab_item_3" data-toggle="tab" href="#team_member_3" role="tab" aria-selected="true">
                                            <div class="team-mem-icon">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/team/team-mem-thumb-2.png" alt="JSOFT">
                                            </div>
                                            <h5>Alex Tuntuni</h5>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="tab_item_4" data-toggle="tab" href="#team_member_4" role="tab" aria-selected="true">
                                            <div class="team-mem-icon">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/team/team-mem-thumb-4.png" alt="JSOFT">
                                            </div>
                                            <h5>Any Anderssen</h5>
                                        </a>
                                    </li>
                            ...
                            <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-member-pro-pic">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/team/team-mem-1.png" alt="JSOFT">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                ...
                                <div class="tab-pane fade" id="team_member_2" role="tabpanel" aria-labelledby="tab_item_2">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-member-pro-pic">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/team/team-mem-3.png" alt="JSOFT">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-member-info text-center">
                                ...
                                <div class="tab-pane fade" id="team_member_3" role="tabpanel" aria-labelledby="tab_item_3">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-member-pro-pic">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/team/team-mem-2.png" alt="JSOFT">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-member-info text-center">
                                ...
                                <div class="tab-pane fade" id="team_member_4" role="tabpanel" aria-labelledby="tab_item_4">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-member-pro-pic">
                                                <img src="<?= base_url() ?>/assets/assets_shop/img/team/team-mem-4.png" alt="JSOFT">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="team-member-info text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="article-thumb">
                                <img src="<?= base_url() ?>/assets/assets_shop/img/article/arti-thumb-1.jpg" alt="JSOFT">
                            </div>
                        </div>
                ...
                <article class="single-article middle">
                    <div class="row">
                        ...
                        <div class="col-lg-5 d-xl-none">
                            <div class="article-thumb">
                                <img src="<?= base_url() ?>/assets/assets_shop/img/article/arti-thumb-2.jpg" alt="JSOFT">
                            </div>
                        </div>
                        <!-- Articles Thumbnail End -->
            ...
            <div class="col-lg-12">
                <article class="single-article">
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="article-thumb">
                                <img src="<?= base_url() ?>/assets/assets_shop/img/article/arti-thumb-3.jpg" alt="JSOFT">
                            </div>
                        </div>
                        <!-- Articles Thumbnail End -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-footer-widget">
                        ...
                        <div class="widget-body">
                            ...
                            <ul class="get-touch">
                                <li><i class="fa fa-map-marker"></i> Cempaka Putih, Jakarta Pusat</li>
