        ...
        <div class="col-md-4">
            <div class="card" style="margin-top: 150px;">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">Bank Mandiri 11284736639</li>
                        <li class="list-group-item">Bank BCA 11284736639</li>
                        <li class="list-group-item">Bank BNI 11284736639</li>
                        <li class="list-group-item">Bank CIMB Niaga 11284736639</li>
                    </ul>
